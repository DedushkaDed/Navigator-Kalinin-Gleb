...
class Version20210514150019 extends Version
{
  ...
  array (
    ...
    array (
      ...
      'DEF' => 'N',
      'SORT' => '500',
      'XML_ID' => 'grid-card--background-primary grid-card--color-white',
    ),
    2 => 
    array (
      'VALUE' => 'Серый',
    ...
    array (
      ...
      'DEF' => 'N',
      'SORT' => '500',
      'XML_ID' => 'grid-card--background-blue grid-card--color-white',
    ),
  ),
));
        $helper->Iblock()->saveProperty($iblockId, array (
  ...
  'HINT' => '',
        ...
        $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Дополнительный текст в блоке',
  'ACTIVE' => 'Y',
  'SORT' => '500',
