...
class Version1020210430092515 extends Version
{
    protected $description = "Простая миграция для инфоблока Факты о компании";
  ...
  array (
    ...
    array (
      ...
      'DEF' => 'N',
      'SORT' => '500',
      'XML_ID' => 'grid-card--background-blue',
    ),
    1 => 
    array (
      'VALUE' => 'Зеленый',
      'DEF' => 'N',
      'SORT' => '500',
      'XML_ID' => 'grid-card--background-primary',
    ),
    2 => 
    array (
      'VALUE' => 'Обводка',
    ...
    array (
      ...
      'DEF' => 'N',
      'SORT' => '500',
      'XML_ID' => 'grid-card--background-sand',
    ),
  ),
));
        $helper->Iblock()->saveProperty($iblockId, array (
