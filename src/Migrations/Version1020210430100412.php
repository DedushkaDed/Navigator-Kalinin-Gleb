...
class Version1020210430100412 extends Version
{
    protected $description = "миграция для инфоблока Тендеры";
  ...
  'HINT' => '',
        ...
        $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Скачать информацию претенденту',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'CODE' => 'DOWNLOAD_INFO',
  'DEFAULT_VALUE' => '',
