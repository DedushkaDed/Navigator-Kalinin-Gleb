...
class Version20210514150014 extends Version
{
  ...
  'CODE' => 'price_list_buyer',
  'API_CODE' => NULL,
  'NAME' => 'Цены на земельные участки',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  ...
  'HINT' => '',
        ...
        $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'В поселке "Альпийская долина" представлены участки',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'CODE' => 'ACRES',
  'DEFAULT_VALUE' => '',
  ...
  'HINT' => '',
        ...
        $helper->Iblock()->saveProperty($iblockId, array (
  'NAME' => 'Минимальная стоимость 1 сотки на 22.03.2019',
  'ACTIVE' => 'Y',
  'SORT' => '500',
  'CODE' => 'ACRES_MIN',
  'DEFAULT_VALUE' => '',
