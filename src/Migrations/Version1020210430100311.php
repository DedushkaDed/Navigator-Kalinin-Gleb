...
class Version1020210430100311 extends Version
{
    protected $description = "миграция для инфоблока Фооточет с мероприятия";
  ...
  'CODE' => 'photo-otchet-s-meropriyatiya',
  'API_CODE' => NULL,
  'NAME' => 'Фотоотчет с мероприятия',
  'ACTIVE' => 'Y',
  'SORT' => '500',
