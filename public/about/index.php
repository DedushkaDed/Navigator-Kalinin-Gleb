        ...
        <div class="container">
            <div class="grid-layout">
                <div class="grid-layout__item">
                    <img class="img" src="<?=$aAboutOptions['imageSection']['image']?>"/>
                </div>
            </div>
                ...
                <div class="grid-layout__item grid-layout__item--md-span-column-1">
                    <div class="grid-card grid-card--background-green grid-card--color-white">
                        <div class="grid-card__content">
                            <div class="grid-card__title"><?=$aAboutOptions['contentSection']['title']?></div>
                            <div class="grid-card__subtext"><?=$aAboutOptions['contentSection']['description']?></div>
                        </div>
                    </div>
                </div>
