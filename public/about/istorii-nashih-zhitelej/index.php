        ...
        <div class="container">
            <div class="tabs-navigation-wrapper">
                <div class="tabs-navigation js-tabs-navigation-static">
                    ...
                    <a class="tabs-navigation__item tabs-navigation__item--active" href="/about/istorii-nashih-zhitelej/">Истории
                        жителей
                    </a>
    ...
    <section class="section mb-large">
        <div class="container">
            <div class="grid-news grid-news--top">
                <div class="grid-news__item grid-news__item--full">
                    <a class="news-card news-card--lg-column" href="/about/istorii-nashih-zhitelej/detail">
                        <div class="news-card__image news-card__image--lg-column">
                            <img src="https://source.unsplash.com/1000x500" alt="С Днем Рождения!"/>
                        </div>
                        <div class="news-card__content news-card__content--xl-content">
                            <div class="news-card__title news-card__title--lg-large">С Днем Рождения!</div>
                ...
                <div class="grid-news__item">
                    <a class="news-card" href="/about/istorii-nashih-zhitelej/detail">
                        <div class="news-card__image">
                            <img src="https://source.unsplash.com/1000x501" alt="С Днем Рождения!"/>
                        </div>
                ...
                <div class="grid-news__item">
                    <a class="news-card" href="/about/istorii-nashih-zhitelej/detail">
                        <div class="news-card__image">
                            <img src="https://source.unsplash.com/1000x502" alt="С Днем Рождения!"/>
                        </div>
                        <div class="news-card__content">
                            <div class="news-card__title">С Днем Рождения!</div>
                            <div class="news-card__text">Мы поздравили постоянных партнеров — агенство недвижимости «СОВА» с днём
                ...
                <div class="grid-news__item">
                    <a class="news-card" href="/about/istorii-nashih-zhitelej/detail">
                        <div class="news-card__image">
                            <img src="https://source.unsplash.com/1000x503" alt="С Днем Рождения!"/>
                        </div>
                        <div class="news-card__content">
                            <div class="news-card__title">С Днем Рождения!</div>
                            <div class="news-card__text">Мы поздравили постоянных партнеров — агенство недвижимости «СОВА» с днём
                ...
                <div class="grid-news__item">
                    <a class="news-card" href="/about/istorii-nashih-zhitelej/detail">
                        <div class="news-card__image">
                            <img src="https://source.unsplash.com/1000x504" alt="С Днем Рождения!"/>
                        </div>
                        <div class="news-card__content">
                            <div class="news-card__title">С Днем Рождения!</div>
                            <div class="news-card__text">Мы поздравили постоянных партнеров — агенство недвижимости «СОВА» с днём
                ...
                <div class="grid-news__item">
                    <a class="news-card" href="/about/istorii-nashih-zhitelej/detail">
                        <div class="news-card__image">
                            <img src="https://source.unsplash.com/1000x505" alt="С Днем Рождения!"/>
                        </div>
                        <div class="news-card__content">
                            <div class="news-card__title">С Днем Рождения!</div>
                            <div class="news-card__text">Мы поздравили постоянных партнеров — агенство недвижимости «СОВА» с днём
