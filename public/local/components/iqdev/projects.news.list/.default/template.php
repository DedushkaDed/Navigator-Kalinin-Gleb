    ...
    <div class="container">
        <div class="gridster">
            <div class="gridster__item">
                <a class="card" href="#">
                    <div class="card__image" style="background-image: url(&quot;../assets/image/card/1.png&quot;)">
                        <div class="card__logo-inner">
                            <div class="card__logo" style="background-image: url(&quot;../../assets/image/logo/alpine.png&quot;)"
                            ></div>
                        </div>
                        <div class="card__name">Альпийская долина</div>
                    </div>
                    <div class="card__content">
                        <div class="card__location">с. Кулига, 25 км по Ирбитскому тракту, уникальный природный ландшафт</div>
                        <div class="card__list">
                            ...
                            <div class="card__list-item card__list-item--access">
                                ...
                                <span>233 доступно</span>
                            </div>
                        </div>
                    </div>
                    <div class="card__footer">
                        <div class="card__spot">Участки от 10 до 12 соток</div>
            ...
            <div class="gridster__item">
                <a class="card" href="#">
                    <div class="card__image" style="background-image: url(&quot;../assets/image/card/2.png&quot;)">
                        <div class="card__logo-inner">
                            <div class="card__logo" style="background-image: url(&quot;../../assets/image/logo/esenino.png&quot;)"
                            ></div>
                        </div>
                        <div class="card__name">Есенино</div>
                    </div>
                    <div class="card__content">
                        <div class="card__location">25 км по Московскому тракту, прилегает к селу Успенка</div>
                        <div class="card__list">
                            <div class="card__list-item card__list-item--sale">
                                <svg width="15" height="18" viewBox="0 0 15 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M14.2857 6.18701H0V17.1861H14.2857V6.18701Z" fill="#7EC95C"></path>
                            ...
                            <div class="card__list-item card__list-item--access">
                                ...
                                <span>145 доступно</span>
                            </div>
                        </div>
                    </div>
                    <div class="card__footer">
                        <div class="card__spot">Участки от 7 до 13 соток</div>
                        <div class="card__button">
                            <div class="arrow-link arrow-link--right">
                                <div class="arrow-link__border">
                                    <svg viewBox="0 0 26 49" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="gridster__item">
                <a class="card card--overlay" href="#">
                    <div class="card__image" style="background-image: url(&quot;../assets/image/card/3.png&quot;)">
                        <div class="card__logo-inner">
                            <div class="card__logo" style="background-image: url(&quot;../../assets/image/logo/elki.png&quot;)"></div>
                        </div>
                        <div class="card__name">Ёлки</div>
                    </div>
                    <div class="card__content">
                        <div class="card__location">18 км по Московскому тракту, окружено густым заповедным лесом</div>
                        <div class="card__list">
                            <div class="card__list-item card__list-item--sale">
                                <svg width="15" height="18" viewBox="0 0 15 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M14.2857 6.18701H0V17.1861H14.2857V6.18701Z" fill="#7EC95C"></path>
            ...
            <div class="gridster__item">
                <a class="card" href="#">
                    <div class="card__image" style="background-image: url(&quot;../assets/image/card/3.png&quot;)">
                        <div class="card__logo-inner">
                            <div class="card__logo" style="background-image: url(&quot;../../assets/image/logo/ushakova.png&quot;)"
                            ></div>
                        </div>
                        <div class="card__name">Ушаково</div>
                    </div>
                    <div class="card__content">
                        <div class="card__location">18 км по Московскому тракту, окружено густым заповедным лесом</div>
                        <div class="card__list">
