...
<section class="section mb-medium">
    <div class="container">
        <div class="section-header"><?=$arParams['questionsTitle'] ?? ''?></div>
        <div class="accordion-container js-accordion">
            <?foreach ($arResult as $aItem) :?>
                <?if (($aItem['isFirst'])) :?>
                    <div class="accordion accordion--active <?=$aItem['backgroundColor'] ?? ''?>">
                        <div class="accordion__header">
                            ...
                            <div class="accordion__header-text">
                                <div class="accordion__header-text-primary"><?=$aItem['title'] ?? ''?></div>
                            </div>
                        </div>
                ...
                <?else :?>
                    <div class="accordion <?=$aItem['backgroundColor'] ?? ''?>">
                        <div class="accordion__header">
                            <div class="accordion__header-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="13" height="9" viewBox="0 0 13 9" fill="none">
                                    <path
