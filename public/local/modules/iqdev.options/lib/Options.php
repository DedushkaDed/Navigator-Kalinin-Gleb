    ...
    public static $allOptions = [
        ...
        'buyer_ipoteka' => [
            ...
            [
                ...
                ['text', 50],
                'Подать заявку на ипотеку возможно в следующие банки:',
            ],
            [
                'infoSection/header',
        ...
        'buyer_rassrochka' => [
            ...
            [
                'firstItem/percent',
                'Процентная ставка в первом блоке',
                ['text', 50],
                '2%',
            ],
            [
            ...
            [
                ...
                '5-ый блок',
                ['text', 50],
                'Вы можете получить индивидуальное предложение о рассрочке!',
            ],
            [
                'fifthItem/buttonLabel',
                'Текст на кнопке',
                ['text', 50],
        ...
        'feedback_form_main' => [
            ...
            [
                ...
                'Описание',
                ['text', 50],
                'Приглашаем вас на обзорную экскурсию по загородной жизни в один из наших поселков. Заполните форму ниже, и мы вам перезвоним.',
            ],
        ],
        '404_page' => [
