                        ...
                        <div class="detail-header">
                            ...
                            <div class="detail-header__footer">
                                ...
                                <div class="detail-header__share">
                                    ...
                                    <a class="detail-header__share-icon" href="<?=$aSocialMediaOptions['facebook']?>" target="_blank">
                                        <div class="icon">
                                    ...
                                    <a class="detail-header__share-icon" href="<?=$aSocialMediaOptions['vkontakte']?>" target="_blank">
                                        <div class="icon">
                                    ...
                                    <a class="detail-header__share-icon" href="<?=$aSocialMediaOptions['odnoklassniki']?>" target="_blank">
                                        <div class="icon">
