        ...
        <div class="modal-success__message">
            ...
            <div class="modal-success__message-icon">
                <svg width="168" height="169" viewBox="0 0 168 169" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                            d="M62.3767 86.3617C67.8967 97.21 76.79 106.065 87.6383 111.623L96.0717 103.19C97.1067 102.155 98.64 101.81 99.9817 102.27C104.275 103.688 108.913 104.455 113.667 104.455C115.775 104.455 117.5 106.18 117.5 108.288V121.667C117.5 123.775 115.775 125.5 113.667 125.5C77.6717 125.5 48.5 96.3283 48.5 60.3333C48.5 58.225 50.225 56.5 52.3333 56.5H65.75C67.8583 56.5 69.5833 58.225 69.5833 60.3333C69.5833 65.125 70.35 69.725 71.7683 74.0183C72.19 75.36 71.8833 76.855 70.81 77.9283L62.3767 86.3617Z"
                            fill="#675A54"
                    ></path>
                    <path fill-rule="evenodd" clip-rule="evenodd"
                          d="M87.3754 6.86727C129.506 8.70367 162.456 43.8767 161.613 86.0761C161.613 86.0762 161.613 86.0763 161.613 86.0763C161.612 86.122 161.611 86.1677 161.61 86.2133C160.692 128.464 126.232 162.236 84.0304 162.253C84.0203 162.253 84.0101 162.253 84 162.253C83.9899 162.253 83.9797 162.253 83.9696 162.253C41.7696 162.236 7.30946 128.464 6.39173 86.2133C6.39074 86.1676 6.38979 86.1218 6.38887 86.0761C5.54521 43.8766 38.4962 8.70354 80.6249 6.86726C80.728 6.86726 80.8284 6.8672 80.9261 6.8671C80.9261 6.8671 80.9262 6.8671 80.9262 6.8671C84.285 6.86368 84.4904 6.8027 84.6999 6.7792C84.8749 6.75957 85.0528 6.76609 87.0744 6.85415C87.1704 6.85833 87.2706 6.8627 87.3751 6.86726C87.3752 6.86726 87.3753 6.86726 87.3754 6.86727ZM167.98 86.3517C166.988 132.129 129.747 168.794 84 169C38.2544 168.794 1.01391 132.129 0.0203065 86.3517C0.0192338 86.3023 0.0182033 86.2529 0.0172152 86.2034C-0.897117 40.4554 34.7212 2.31163 80.3309 0.121834C80.4288 0.117131 80.5268 0.112594 80.6249 0.108222C84.392 -0.0596807 85.3085 0.00396773 86.1107 0.0596719C86.472 0.0847632 86.8102 0.108243 87.3751 0.108222C87.4732 0.112593 87.5712 0.117131 87.6691 0.121833C133.279 2.31162 168.897 40.4554 167.983 86.2034C167.982 86.2529 167.981 86.3023 167.98 86.3517Z"
                          fill="#675A54"
                    ></path>
                </svg>
            </div>
    ...
    <div class="modal js-modal" data-modal-open="calculation">
        <div class="modal__content">
            ...
            <form class="modal__form js-form" action="/?ajaxAction=formCalculation" data-name="calculation">
                ...
                <div class="modal__input">
                    <div class="input js-input">
                        <input class="input__field" type="text" name="email" placeholder="Электронная почта"
                ...
                <input type="hidden" name="first-pay" data-modal-import="first-pay"/>
                <input type="hidden" name="term" data-modal-import="term"/>
                <input type="hidden" name="is-member" data-modal-import="is-member"/>
                <input type="hidden" name="selectedBank" data-modal-import="selectedBank"/>
                <input type="hidden" name="calculatedRate" data-modal-import="calculatedRate"/>
                <div class="modal__checkbox">
                    <div class="checkbox js-checkbox">
                        <label class="checkbox__label">
                            <input class="checkbox__field" type="checkbox" data-validate="required"/>
